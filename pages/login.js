        ...
        <div className='bg-white w-[50%] shadow-md h-fit flex flex-col-3 justify-between pt-5  pb-10 px-10 m-auto '>
          ...
          <div className=' gap-y-10'>
            ...
            <div class="flex items-center justify-center my-10">
              <button onClick={signinwithgoogle} class="flex w-[320px]  text-center  items-center bg-white border border-gray-300 rounded-lg shadow-md px-6 py-4 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            ...
            <div class="flex   items-center justify-center my-10">
              <button class="flex  w-[320px]  text-center items-center bg-white border border-gray-300 rounded-lg shadow-md px-6 py-4 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            ...
            <div class="flex items-center justify-center my-10">
              <button onClick={signinwithgithub} class=" w-[320px]  text-center flex items-center bg-white border border-gray-300 rounded-lg shadow-md px-6 py-4 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
