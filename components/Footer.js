...
const Footer = () => {
    return (
        <div>
            <footer class=" bg-[#3fb5eb] text-white shadow-md pt-8 pb-6">
                <div class="container mx-auto px-4">
                    <div class="flex flex-wrap text-left lg:text-left">
                        <div class="w-full lg:w-6/12 px-4">
                            ...
                            <div class="mt-6 lg:mb-0 flex gap-x-5 mb-6">
                        ...
                        <div class="w-full lg:w-6/12 px-4">
                            <div class="flex flex-wrap items-top mb-6">
                                <div class="w-full lg:w-4/12 px-4 ml-auto">
                                    <span class="block uppercase text-blueGray-500 text-sm font-semibold mb-2">Featured Categories</span>
                    ...
                    <div class="flex flex-wrap items-center md:justify-between justify-center">
                        <div class="w-full md:w-4/12 px-4 mx-auto text-center">
                            <div class="text-sm text-blueGray-500 font-semibold py-1">
                                Copyright © <span id="get-current-year">2023</span><a href="https://www.creative-tim.com/product/notus-js" class="text-blueGray-500 hover:text-gray-800" target="_blank" /> Drug Wise by
                                <a href="https://www.linkedin.com/in/deepak-chattwani-340bb8227/" class="text-blueGray-500 hover:text-blueGray-800"> Deep</a>.
                            </div>
                        </div>
                    </div>
                </div>
